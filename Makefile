...
bin_PROGRAMS = utilities/ovs-appctl$(EXEEXT) \
	...
	ovn/controller/ovn-controller$(EXEEXT) \
	...
	ovn/utilities/ovn-trace$(EXEEXT)
...
noinst_PROGRAMS = $(am__EXEEXT_1) tests/test-ovsdb$(EXEEXT) \
	tests/test-lib$(EXEEXT) $(am__EXEEXT_2) tests/ovstest$(EXEEXT) \
...
am__append_18 = -Wno-unused
am__append_19 = -Wno-unused-parameter
am__append_20 = \
	lib/dpif-netlink.c \
	lib/dpif-netlink.h \
	lib/if-notifier.c \
...
am__append_24 = lib/async-append-aio.c
#am__append_25 = lib/async-append-null.c
#am__append_26 = \
#	lib/route-table-stub.c \
#	lib/if-notifier-stub.c
...
am__append_28 = lib/stream-ssl.c
am__append_29 = lib/dhparams.c
#am__append_30 = lib/stream-nossl.c
#am__append_31 = ${PTHREAD_LIBS}
am__append_32 = \
...
am__append_33 = utilities/ovs-vlan-bug-workaround
am__append_34 = utilities/nlmon
am__append_35 = utilities/bugtool/ovs-bugtool
am__append_36 = utilities/bugtool/ovs-bugtool
am__append_37 = utilities/bugtool/ovs-bugtool.8
am__append_38 = utilities/bugtool/ovs-bugtool.8.in
am__append_39 = utilities/bugtool/ovs-bugtool.8
am__append_40 = $(bugtool_scripts)
am__append_41 = utilities/bugtool/ovs-bugtool.in
am__append_42 = bugtool-install-data-local
am__append_43 = bugtool-uninstall-local
#am__append_44 = tests/test-dpdkr
am__append_45 = \
...
am__append_47 = $(TESTPKI_FILES)
am__append_48 = $(TESTPKI_FILES) tests/ovs-pki.log
am__append_49 = clean-pki
am__append_50 = .h .hstamp
am__append_51 = $(HSTAMP_FILES)
am__append_52 = $(HSTAMP_FILES)
am__append_53 = vswitchd/vswitch.gv vswitchd/vswitch.pic
am__append_54 = vtep/vtep.gv vtep/vtep.pic
#am__append_55 = $(srcdir)/datapath-windows/include/OvsDpInterface.h
am__append_56 = ovn/ovn-sb.gv ovn/ovn-sb.pic
am__append_57 = ovn/ovn-nb.gv ovn/ovn-nb.pic
subdir = .
...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	...
	$(openvswitchinclude_HEADERS) $(ovninclude_HEADERS) \
	$(am__DIST_COMMON)
...
CONFIG_CLEAN_FILES = lib/stdio.h lib/string.h ovsdb/libovsdb.sym \
	...
	ovn/lib/libovn.sym vtep/libvtep.sym datapath/linux/Kbuild \
	datapath/linux/Makefile datapath/linux/Makefile.main \
	tests/atlocal lib/libopenvswitch.pc lib/libsflow.pc \
...
am__lib_libopenvswitch_la_SOURCES_DIST = lib/aes128.c lib/aes128.h \
	...
	lib/conntrack-tcp.c lib/conntrack-other.c lib/conntrack.c \
	lib/conntrack.h lib/coverage.c lib/coverage.h lib/crc32c.c \
	...
	lib/dp-packet.h lib/dp-packet.c lib/dpdk.h lib/dpif-netdev.c \
	lib/dpif-netdev.h lib/dpif-provider.h lib/dpif.c lib/dpif.h \
	lib/heap.c lib/heap.h lib/dynamic-string.c lib/entropy.c \
	...
	lib/learning-switch.h lib/lockfile.c lib/lockfile.h \
	lib/mac-learning.c lib/mac-learning.h lib/match.c \
	lib/mcast-snooping.c lib/mcast-snooping.h lib/memory.c \
	lib/memory.h lib/meta-flow.c lib/multipath.c lib/multipath.h \
	lib/netdev-dpdk.h lib/netdev-dummy.c lib/netdev-provider.h \
	lib/netdev-vport.c lib/netdev-vport.h \
	lib/netdev-vport-private.h lib/netdev.c lib/netdev.h \
	lib/netflow.h lib/netlink.c lib/netlink.h lib/nx-match.c \
	lib/nx-match.h lib/object-collection.c lib/object-collection.h \
	lib/odp-execute.c lib/odp-execute.h lib/odp-util.c \
	lib/odp-util.h lib/ofp-actions.c lib/ofp-errors.c \
	lib/ofp-msgs.c lib/ofp-parse.c lib/ofp-print.c lib/ofp-prop.c \
	lib/ofp-util.c lib/ofp-version-opt.h lib/ofp-version-opt.c \
	lib/ofpbuf.c lib/ovs-atomic-c11.h lib/ovs-atomic-clang.h \
	...
	lib/ovs-thread.c lib/ovs-thread.h lib/ovsdb-data.c \
	...
	lib/ovsdb-types.h lib/packets.c lib/packets.h lib/pcap-file.c \
	lib/pcap-file.h lib/perf-counter.h lib/perf-counter.c \
	lib/poll-loop.c lib/poll-loop.h lib/process.c lib/process.h \
	lib/pvector.c lib/pvector.h lib/random.c lib/random.h \
	lib/rconn.c lib/rconn.h lib/rculist.h lib/reconnect.c \
	lib/reconnect.h lib/rstp.c lib/rstp.h lib/rstp-common.h \
	lib/rstp-state-machines.c lib/rstp-state-machines.h \
	lib/sat-math.h lib/seq.c lib/seq.h lib/sha1.c lib/sha1.h \
	lib/shash.c lib/simap.c lib/simap.h lib/smap.c lib/smap.h \
	...
	lib/netdev-native-tnl.c lib/netdev-native-tnl.h \
	...
	lib/vconn.c lib/versions.h lib/vl-mff-map.h lib/vlan-bitmap.c \
	lib/vlan-bitmap.h lib/vlog.c lib/lldp/aa-structs.h \
	lib/lldp/lldp.c lib/lldp/lldp-const.h lib/lldp/lldp-tlv.h \
	lib/lldp/lldpd.c lib/lldp/lldpd.h lib/lldp/lldpd-structs.c \
	lib/lldp/lldpd-structs.h lib/daemon-windows.c \
	lib/getopt_long.c lib/getrusage-windows.c lib/latch-windows.c \
	lib/route-table-stub.c lib/if-notifier-stub.c \
	lib/stream-windows.c lib/strsep.c lib/daemon-unix.c \
	...
	lib/rtnetlink.h lib/route-table.c lib/route-table.h lib/dpdk.c \
	lib/netdev-dpdk.c lib/dpdk-stub.c lib/netdev-windows.c \
	lib/wmi.c lib/wmi.h lib/async-append-aio.c \
...
am__objects_3 = lib/dpif-netlink.lo lib/if-notifier.lo \
	...
	lib/rtnetlink.lo lib/route-table.lo
#am__objects_4 = lib/dpdk.lo lib/netdev-dpdk.lo
am__objects_5 = lib/dpdk-stub.lo
#am__objects_6 = lib/dpif-netlink.lo lib/netdev-windows.lo \
#	lib/netlink-conntrack.lo lib/netlink-notifier.lo \
#	lib/netlink-socket.lo lib/wmi.lo
am__objects_7 = lib/async-append-aio.lo
#am__objects_8 = lib/async-append-null.lo
#am__objects_9 = lib/route-table-stub.lo \
#	lib/if-notifier-stub.lo
#am__objects_10 = lib/if-notifier-bsd.lo \
#	lib/netdev-bsd.lo lib/rtbsd.lo \
#	lib/route-table-bsd.lo
am__objects_11 = lib/stream-ssl.lo
...
am_lib_libopenvswitch_la_OBJECTS = lib/aes128.lo lib/backtrace.lo \
	...
	lib/conntrack-tcp.lo lib/conntrack-other.lo lib/conntrack.lo \
	lib/coverage.lo lib/crc32c.lo lib/csum.lo lib/ct-dpif.lo \
	lib/daemon.lo lib/db-ctl-base.lo lib/dummy.lo lib/dpctl.lo \
	lib/dp-packet.lo lib/dpif-netdev.lo lib/dpif.lo lib/heap.lo \
	...
	lib/ofp-parse.lo lib/ofp-print.lo lib/ofp-prop.lo \
	...
	lib/ovsdb-parser.lo lib/ovsdb-types.lo lib/packets.lo \
	lib/pcap-file.lo lib/perf-counter.lo lib/poll-loop.lo \
	lib/process.lo lib/pvector.lo lib/random.lo lib/rconn.lo \
	lib/reconnect.lo lib/rstp.lo lib/rstp-state-machines.lo \
	lib/seq.lo lib/sha1.lo lib/shash.lo lib/simap.lo lib/smap.lo \
	lib/socket-util.lo lib/sort.lo lib/sset.lo lib/stp.lo \
	lib/stream-fd.lo lib/stream-tcp.lo lib/stream.lo lib/stdio.lo \
	lib/string.lo lib/svec.lo lib/syslog-direct.lo \
	lib/syslog-libc.lo lib/table.lo lib/timer.lo lib/timeval.lo \
	lib/tnl-neigh-cache.lo lib/tnl-ports.lo \
	lib/netdev-native-tnl.lo lib/token-bucket.lo \
	lib/tun-metadata.lo lib/unicode.lo lib/unixctl.lo lib/util.lo \
	lib/uuid.lo lib/vconn-stream.lo lib/vconn.lo \
	lib/vlan-bitmap.lo lib/vlog.lo lib/lldp/lldp.lo \
	lib/lldp/lldpd.lo lib/lldp/lldpd-structs.lo $(am__objects_1) \
	$(am__objects_2) $(am__objects_3) $(am__objects_4) \
	$(am__objects_5) $(am__objects_6) $(am__objects_7) \
	$(am__objects_8) $(am__objects_9) $(am__objects_10) \
	$(am__objects_11) $(am__objects_12)
am__objects_13 = lib/dhparams.lo
nodist_lib_libopenvswitch_la_OBJECTS = lib/dirs.lo lib/vswitch-idl.lo \
	$(am__objects_13)
...
ovn_lib_libovn_la_LIBADD =
am_ovn_lib_libovn_la_OBJECTS = ovn/lib/actions.lo ovn/lib/expr.lo \
	ovn/lib/lex.lo ovn/lib/ovn-util.lo ovn/lib/logical-fields.lo
nodist_ovn_lib_libovn_la_OBJECTS = ovn/lib/ovn-nb-idl.lo \
	ovn/lib/ovn-sb-idl.lo
ovn_lib_libovn_la_OBJECTS = $(am_ovn_lib_libovn_la_OBJECTS) \
	$(nodist_ovn_lib_libovn_la_OBJECTS)
ovn_lib_libovn_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC \
	$(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link $(CCLD) \
...
#am__EXEEXT_2 = tests/test-dpdkr$(EXEEXT)
am__EXEEXT_3 = utilities/ovs-vlan-bug-workaround$(EXEEXT)
...
am_ovn_controller_vtep_ovn_controller_vtep_OBJECTS =  \
	...
	ovn/controller-vtep/ovn-controller-vtep.$(OBJEXT) \
	ovn/controller-vtep/vtep.$(OBJEXT)
ovn_controller_vtep_ovn_controller_vtep_OBJECTS =  \
	$(am_ovn_controller_vtep_ovn_controller_vtep_OBJECTS)
ovn_controller_vtep_ovn_controller_vtep_DEPENDENCIES =  \
	ovn/lib/libovn.la lib/libopenvswitch.la vtep/libvtep.la
am_ovn_controller_ovn_controller_OBJECTS =  \
	ovn/controller/binding.$(OBJEXT) \
	ovn/controller/chassis.$(OBJEXT) \
	ovn/controller/encaps.$(OBJEXT) ovn/controller/lflow.$(OBJEXT) \
	ovn/controller/lport.$(OBJEXT) ovn/controller/ofctrl.$(OBJEXT) \
	ovn/controller/pinctrl.$(OBJEXT) \
	ovn/controller/patch.$(OBJEXT) \
	ovn/controller/ovn-controller.$(OBJEXT) \
	ovn/controller/physical.$(OBJEXT)
ovn_controller_ovn_controller_OBJECTS =  \
	$(am_ovn_controller_ovn_controller_OBJECTS)
ovn_controller_ovn_controller_DEPENDENCIES = ovn/lib/libovn.la \
	lib/libopenvswitch.la
am_ovn_northd_ovn_northd_OBJECTS = ovn/northd/ovn-northd.$(OBJEXT)
ovn_northd_ovn_northd_OBJECTS = $(am_ovn_northd_ovn_northd_OBJECTS)
ovn_northd_ovn_northd_DEPENDENCIES = ovn/lib/libovn.la \
	ovsdb/libovsdb.la lib/libopenvswitch.la
am_ovn_utilities_ovn_nbctl_OBJECTS =  \
	ovn/utilities/ovn-nbctl.$(OBJEXT)
ovn_utilities_ovn_nbctl_OBJECTS =  \
	$(am_ovn_utilities_ovn_nbctl_OBJECTS)
ovn_utilities_ovn_nbctl_DEPENDENCIES = ovn/lib/libovn.la \
	ovsdb/libovsdb.la lib/libopenvswitch.la
am_ovn_utilities_ovn_sbctl_OBJECTS =  \
	ovn/utilities/ovn-sbctl.$(OBJEXT)
ovn_utilities_ovn_sbctl_OBJECTS =  \
	$(am_ovn_utilities_ovn_sbctl_OBJECTS)
ovn_utilities_ovn_sbctl_DEPENDENCIES = ovn/lib/libovn.la \
	ovsdb/libovsdb.la lib/libopenvswitch.la
am_ovn_utilities_ovn_trace_OBJECTS =  \
	ovn/utilities/ovn-trace.$(OBJEXT)
ovn_utilities_ovn_trace_OBJECTS =  \
	$(am_ovn_utilities_ovn_trace_OBJECTS)
ovn_utilities_ovn_trace_DEPENDENCIES = ovn/lib/libovn.la \
	ovsdb/libovsdb.la lib/libopenvswitch.la
...
am__tests_ovstest_SOURCES_DIST = tests/ovstest.c tests/ovstest.h \
	...
	tests/test-ccmap.c tests/test-cmap.c tests/test-conntrack.c \
	tests/test-csum.c tests/test-flows.c tests/test-hash.c \
	tests/test-heap.c tests/test-hindex.c tests/test-hmap.c \
	tests/test-json.c tests/test-jsonrpc.c tests/test-list.c \
	tests/test-lockfile.c tests/test-multipath.c \
	tests/test-netflow.c tests/test-odp.c tests/test-ofpbuf.c \
	tests/test-ovn.c tests/test-packets.c tests/test-random.c \
	tests/test-rcu.c tests/test-reconnect.c tests/test-rstp.c \
	tests/test-sflow.c tests/test-sha1.c tests/test-stp.c \
...
am__objects_14 = tests/test-unix-socket.$(OBJEXT)
am__objects_15 = tests/test-netlink-conntrack.$(OBJEXT)
am_tests_ovstest_OBJECTS = tests/ovstest.$(OBJEXT) \
	...
	tests/test-ovn.$(OBJEXT) tests/test-packets.$(OBJEXT) \
	...
	tests/test-aa.$(OBJEXT) $(am__objects_14) $(am__objects_15)
tests_ovstest_OBJECTS = $(am_tests_ovstest_OBJECTS)
tests_ovstest_DEPENDENCIES = lib/libopenvswitch.la ovn/lib/libovn.la
am__tests_test_dpdkr_SOURCES_DIST = tests/dpdk/ring_client.c
#am_tests_test_dpdkr_OBJECTS =  \
#	tests/dpdk/ring_client.$(OBJEXT)
tests_test_dpdkr_OBJECTS = $(am_tests_test_dpdkr_OBJECTS)
#tests_test_dpdkr_DEPENDENCIES =  \
...
SOURCES = $(lib_libopenvswitch_la_SOURCES) \
	...
	$(ovn_utilities_ovn_nbctl_SOURCES) \
	$(ovn_utilities_ovn_sbctl_SOURCES) \
	$(ovn_utilities_ovn_trace_SOURCES) \
	$(ovsdb_ovsdb_client_SOURCES) $(ovsdb_ovsdb_server_SOURCES) \
	$(ovsdb_ovsdb_tool_SOURCES) $(tests_ovstest_SOURCES) \
	$(tests_test_dpdkr_SOURCES) $(tests_test_lib_SOURCES) \
...
DIST_SOURCES = $(am__lib_libopenvswitch_la_SOURCES_DIST) \
	$(lib_libsflow_la_SOURCES) $(ofproto_libofproto_la_SOURCES) \
	$(ovn_lib_libovn_la_SOURCES) $(ovsdb_libovsdb_la_SOURCES) \
	$(ovn_controller_vtep_ovn_controller_vtep_SOURCES) \
	$(ovn_controller_ovn_controller_SOURCES) \
	$(ovn_northd_ovn_northd_SOURCES) \
	$(ovn_utilities_ovn_nbctl_SOURCES) \
	...
	$(ovn_utilities_ovn_trace_SOURCES) \
	$(ovsdb_ovsdb_client_SOURCES) $(ovsdb_ovsdb_server_SOURCES) \
	$(ovsdb_ovsdb_tool_SOURCES) $(am__tests_ovstest_SOURCES_DIST) \
	$(am__tests_test_dpdkr_SOURCES_DIST) $(tests_test_lib_SOURCES) \
...
am__noinst_HEADERS_DIST = AUTHORS.rst CONTRIBUTING.rst MAINTAINERS.rst \
	README.rst NOTICE .travis.yml .travis/linux-build.sh \
	.travis/linux-prepare.sh .travis/osx-build.sh \
	.travis/osx-prepare.sh appveyor.yml boot.sh build-aux/cccl \
	build-aux/cksum-schema-check build-aux/calculate-schema-cksum \
	...
	ofproto/ofproto-tnl-unixctl.man utilities/ovs-vlan-bugs.man \
	ovsdb/remote-active.man ovsdb/remote-passive.man \
	ovsdb/replication.man ovsdb/replication-syn.man \
	utilities/ovs-appctl.8.in utilities/ovs-testcontroller.8.in \
	...
	utilities/ovs-tcpdump.8.in utilities/ovs-tcpundump.1.in \
	utilities/ovs-vlan-bug-workaround.8.in utilities/ovs-test.8.in \
	utilities/ovs-vlan-test.8.in utilities/ovs-vsctl.8.in \
	utilities/bugtool/ovs-bugtool.8.in vswitchd/ovs-vswitchd.8.in \
	ovsdb/ovsdb-tool.1.in ovsdb/ovsdb-client.1.in \
	ovsdb/ovsdb-server.1.in ovsdb/ovsdb-idlc.1 vtep/vtep-ctl.8.in \
	ovn/utilities/ovn-sbctl.8.in Vagrantfile Vagrantfile-FreeBSD \
	.mailmap build-aux/thread-safety-blacklist \
	Documentation/group-selection-method-property.txt \
	Documentation/_static/logo.png \
	Documentation/_static/overview.png Documentation/conf.py \
	Documentation/index.rst Documentation/contents.rst \
	...
	Documentation/topics/windows.rst Documentation/howto/index.rst \
	Documentation/howto/docker.rst Documentation/howto/dpdk.rst \
	Documentation/howto/kvm.rst Documentation/howto/libvirt.rst \
	Documentation/howto/selinux.rst Documentation/howto/ssl.rst \
	Documentation/howto/lisp.rst \
	Documentation/howto/openstack-containers.rst \
	Documentation/howto/qos.png Documentation/howto/qos.rst \
	Documentation/howto/sflow.png Documentation/howto/sflow.rst \
	Documentation/howto/tunneling.png \
	Documentation/howto/tunneling.rst \
	Documentation/howto/userspace-tunneling.rst \
	Documentation/howto/vlan.png Documentation/howto/vlan.rst \
	Documentation/howto/vtep.rst Documentation/ref/index.rst \
	Documentation/faq/index.rst \
	Documentation/faq/configuration.rst \
	Documentation/faq/contributing.rst \
	Documentation/faq/design.rst Documentation/faq/general.rst \
	Documentation/faq/issues.rst Documentation/faq/openflow.rst \
	Documentation/faq/qos.rst Documentation/faq/releases.rst \
	Documentation/faq/terminology.rst Documentation/faq/vlan.rst \
	Documentation/faq/vxlan.rst Documentation/internals/index.rst \
	...
	Documentation/requirements.txt m4/absolute-header.m4 \
	m4/include_next.m4 lib/stdio.h.in lib/string.h.in \
	lib/dh1024.pem lib/dh2048.pem lib/dh4096.pem lib/common.xml \
	lib/daemon.xml lib/dirs.c.in lib/db-ctl-base.xml lib/ssl.xml \
	lib/ssl-bootstrap.xml lib/vlog.xml lib/vswitch-idl.ann \
	build-aux/extract-ofp-fields build-aux/extract-ofp-actions \
	build-aux/extract-ofp-errors build-aux/extract-ofp-msgs \
	lib/meta-flow.xml ofproto/ipfix.xml \
	...
	utilities/bugtool/ovs-bugtool.in tests/ovsdb-macros.at \
	tests/ovs-macros.at tests/ofproto-macros.at tests/testsuite.at \
	tests/completion.at tests/library.at tests/heap.at \
	...
	tests/ovs-ofctl.at tests/odp.at tests/mpls-xlate.at \
	tests/multipath.at tests/bfd.at tests/cfm.at tests/lacp.at \
	tests/lib.at tests/learn.at tests/vconn.at tests/file_name.at \
	tests/aes128.at tests/unixctl-py.at tests/uuid.at \
	tests/json.at tests/jsonrpc.at tests/jsonrpc-py.at \
	tests/pmd.at tests/tunnel.at tests/tunnel-push-pop.at \
	tests/tunnel-push-pop-ipv6.at tests/ovs-router.at \
	tests/lockfile.at tests/reconnect.at tests/ovs-vswitchd.at \
	tests/dpif-netdev.at tests/dpctl.at tests/ofproto-dpif.at \
	tests/bridge.at tests/ofproto.at tests/netdev-type.at \
	tests/ovsdb.at tests/ovsdb-log.at tests/ovsdb-types.at \
	tests/ovsdb-data.at tests/ovsdb-column.at tests/ovsdb-table.at \
	tests/ovsdb-row.at tests/ovsdb-schema.at \
	tests/ovsdb-condition.at tests/ovsdb-mutation.at \
	tests/ovsdb-query.at tests/ovsdb-transaction.at \
	tests/ovsdb-execution.at tests/ovsdb-trigger.at \
	tests/ovsdb-tool.at tests/ovsdb-replication.at \
	tests/ovsdb-server.at tests/ovsdb-monitor.at \
	tests/ovsdb-idl.at tests/ovsdb-lock.at tests/ovs-vsctl.at \
	tests/ovs-xapi-sync.at tests/stp.at tests/rstp.at \
	tests/interface-reconfigure.at tests/vlog.at tests/vtep-ctl.at \
	tests/auto-attach.at tests/ovn.at tests/ovn-nbctl.at \
	tests/ovn-sbctl.at tests/ovn-controller.at \
	tests/ovn-controller-vtep.at tests/mcast-snooping.at \
	tests/system-common-macros.at tests/system-ovn.at \
	...
	$(srcdir)/tests/system-userspace-testsuite tests/atlocal.in \
	$(srcdir)/package.m4 $(srcdir)/tests/testsuite.patch \
	...
	tests/idltest.ann tests/idltest2.ovsschema tests/appctl.py \
	tests/test-daemon.py tests/test-json.py tests/test-jsonrpc.py \
	tests/test-l7.py tests/test-ovsdb.py tests/test-reconnect.py \
	tests/MockXenAPI.py tests/test-unix-socket.py \
	tests/test-unixctl.py tests/test-vlog.py \
	build-aux/extract-odp-netlink-h build-aux/check-structs \
	...
	debian/openvswitch-dev.install debian/openvswitch-pki.dirs \
	...
	debian/openvswitch-vtep.manpages debian/ovn-central.dirs \
	debian/ovn-central.init debian/ovn-central.install \
	debian/ovn-central.manpages debian/ovn-central.postinst \
	debian/ovn-central.postrm debian/ovn-central.template \
	debian/ovn-controller-vtep.init \
	debian/ovn-controller-vtep.install \
	debian/ovn-controller-vtep.manpages debian/ovn-common.install \
	debian/ovn-common.manpages debian/ovn-common.postinst \
	debian/ovn-common.postrm debian/ovn-docker.install \
	debian/ovn-host.dirs debian/ovn-host.init \
	debian/ovn-host.install debian/ovn-host.manpages \
	debian/ovn-host.postinst debian/ovn-host.postrm \
	debian/ovn-host.template debian/python-openvswitch.dirs \
	...
	ovsdb/dot2pic rhel/README.RHEL.rst rhel/automake.mk \
	...
	python/README.rst python/setup.py python/ovs/_json.c \
	python/ovs/__init__.py python/ovs/daemon.py \
	python/ovs/fcntl_win.py python/ovs/db/__init__.py \
	python/ovs/db/data.py python/ovs/db/error.py \
	python/ovs/db/idl.py python/ovs/db/parser.py \
	python/ovs/db/schema.py python/ovs/db/types.py \
	python/ovs/fatal_signal.py python/ovs/json.py \
	python/ovs/jsonrpc.py python/ovs/ovsuuid.py \
	...
	python/ovs/version.py python/ovs/vlog.py \
	python/ovs/winutils.py python/ovs/dirs.py \
	...
	vtep/vtep-idl.ann vtep/ovs-vtep vtep/vtep.ovsschema \
	...
	ovn/ovn-sb.ovsschema ovn/ovn-sb.xml ovn/ovn-nb.ovsschema \
	ovn/ovn-nb.xml ovn/ovn-architecture.7.xml ovn/TODO.rst \
	ovn/controller/ovn-controller.8.xml \
	ovn/controller-vtep/ovn-controller-vtep.8.xml \
	ovn/lib/ovn-sb-idl.ann ovn/lib/ovn-nb-idl.ann \
	ovn/northd/ovn-northd.8.xml ovn/utilities/ovn-ctl \
	ovn/utilities/ovn-ctl.8.xml \
	ovn/utilities/ovn-docker-overlay-driver \
	ovn/utilities/ovn-docker-underlay-driver \
	ovn/utilities/ovn-nbctl.8.xml ovn/utilities/ovn-trace.8.xml \
	ovn/utilities/ovndb-servers.ocf selinux/openvswitch-custom.te \
	include/sparse/arpa/inet.h include/sparse/assert.h \
	include/sparse/bmi2intrin.h include/sparse/emmintrin.h \
	include/sparse/math.h include/sparse/netinet/in.h \
	include/sparse/netinet/ip6.h include/sparse/netpacket/packet.h \
	include/sparse/pthread.h include/sparse/rte_atomic.h \
	include/sparse/rte_lcore.h include/sparse/rte_vect.h \
...
am__DIST_COMMON = $(dist_man_MANS) $(srcdir)/Documentation/automake.mk \
	...
	$(srcdir)/include/ovn/automake.mk \
	...
	$(srcdir)/ovn/utilities/bugtool/automake.mk \
	...
	$(top_srcdir)/vtep/libvtep.sym.in COPYING NEWS \
...
ACLOCAL = ${SHELL} /home/shengliu/Workspace/ovs_hehe/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/shengliu/Workspace/ovs_hehe/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/shengliu/Workspace/ovs_hehe/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /home/shengliu/Workspace/ovs_hehe/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /home/shengliu/Workspace/ovs_hehe/build-aux/missing automake-1.15
AWK = mawk
CAPNG_LDADD = 
...
LT_REVISION = 0
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/shengliu/Workspace/ovs_hehe/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MSVC64_LDFLAGS = 
MSVC_CFLAGS = 
...
OVS_CFLAGS =  -Werror
OVS_LDFLAGS = 
OVS_LTINFO = -release 2.7 -version-info 1:2
PACKAGE = openvswitch
PACKAGE_BUGREPORT = bugs@openvswitch.org
PACKAGE_NAME = openvswitch
PACKAGE_STRING = openvswitch 2.7.2
...
abs_builddir = /home/shengliu/Workspace/ovs_hehe
abs_srcdir = /home/shengliu/Workspace/ovs_hehe
abs_top_builddir = /home/shengliu/Workspace/ovs_hehe
abs_top_srcdir = /home/shengliu/Workspace/ovs_hehe
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/shengliu/Workspace/ovs_hehe/build-aux/install-sh
...
CLEANFILES = $(am__append_7) $(am__append_9) flake8-check \
	...
	lib/ovs-fields.7 ofproto/ipfix-entities.def $(am__append_36) \
	$(valgrind_wrappers) $(am__append_48) include/odp-netlink.h \
	$(am__append_51) vswitchd/vswitch.ovsschema.stamp \
	vswitchd/vswitch-idl.c vswitchd/vswitch-idl.h $(OVSIDL_BUILT) \
	vtep/vtep.ovsschema.stamp \
	$(srcdir)/datapath-windows/include/OvsDpInterface.h \
	ovn/ovn-nb.ovsschema.stamp ovn/ovn-sb.ovsschema.stamp

# lcov support
# Requires build with --enable-coverage and lcov/genhtml in $PATH
CLEAN_LOCAL = clean-pycov $(am__append_12) $(am__append_14) clean-lcov \
	$(am__append_49)
DISTCLEANFILES = utilities/ovs-appctl.8 utilities/ovs-ctl \
	...
	utilities/ovs-sim utilities/ovs-sim.1 utilities/ovs-tcpdump \
	utilities/ovs-tcpdump.8 utilities/ovs-tcpundump \
	...
	utilities/ovs-vsctl.8 $(am__append_39) tests/atconfig \
	tests/atlocal debian/copyright vswitchd/ovs-vswitchd.8 \
	$(am__append_53) vswitchd/ovs-vswitchd.conf.db.5 \
	ovsdb/ovsdb-tool.1 ovsdb/ovsdb-client.1 ovsdb/ovsdb-server.1 \
	ovsdb/ovsdb-idlc ovsdb/ovsdb-dot vtep/vtep-ctl.8 \
	$(am__append_54) vtep/vtep.5 $(am__append_56) ovn/ovn-sb.5 \
	$(am__append_57) ovn/ovn-nb.5 ovn/ovn-architecture.7 \
	ovn/controller/ovn-controller.8 \
	ovn/controller-vtep/ovn-controller-vtep.8 \
	ovn/northd/ovn-northd.8 ovn/utilities/ovn-ctl.8 \
	ovn/utilities/ovn-nbctl.8 ovn/utilities/ovn-sbctl.8 \
...
EXTRA_DIST = AUTHORS.rst CONTRIBUTING.rst MAINTAINERS.rst README.rst \
	NOTICE .travis.yml .travis/linux-build.sh \
	.travis/linux-prepare.sh .travis/osx-build.sh \
	.travis/osx-prepare.sh appveyor.yml boot.sh build-aux/cccl \
	build-aux/cksum-schema-check build-aux/calculate-schema-cksum \
	build-aux/dist-docs build-aux/sodepends.pl \
	build-aux/soexpand.pl build-aux/xml2nroff $(MAN_FRAGMENTS) \
	$(MAN_ROOTS) Vagrantfile Vagrantfile-FreeBSD .mailmap \
	...
	utilities/bugtool/ovs-bugtool.in $(COMMON_MACROS_AT) \
	$(TESTSUITE_AT) $(SYSTEM_TESTSUITE_AT) \
	$(SYSTEM_KMOD_TESTSUITE_AT) $(SYSTEM_USERSPACE_TESTSUITE_AT) \
	$(TESTSUITE) $(SYSTEM_KMOD_TESTSUITE) \
	$(SYSTEM_USERSPACE_TESTSUITE) tests/atlocal.in \
	$(srcdir)/package.m4 $(srcdir)/tests/testsuite \
	$(srcdir)/tests/testsuite.patch tests/valgrind-wrapper.in \
	tests/glibc.supp tests/openssl.supp tests/run-oftest \
	tests/run-ryu tests/uuidfilt.pl tests/ovsdb-monitor-sort.pl \
	$(IDLTEST_IDL_FILES) tests/idltest2.ovsschema $(CHECK_PYFILES) \
	build-aux/extract-odp-netlink-h build-aux/check-structs \
	third-party/ofp-tcpdump.patch third-party/README.rst \
	debian/changelog debian/compat debian/control \
	debian/control.modules.in debian/copyright debian/copyright.in \
	...
	python/build/__init__.py python/build/nroff.py \
	python/README.rst python/setup.py python/ovs/_json.c \
	$(PYFILES) python/ovs/dirs.py.template tutorial/ovs-sandbox \
	tutorial/t-setup tutorial/t-stage0 tutorial/t-stage1 \
	tutorial/t-stage2 tutorial/t-stage3 tutorial/t-stage4 \
	vtep/vtep-idl.ann vtep/ovs-vtep vtep/vtep.ovsschema \
	vtep/vtep.xml datapath-windows/Package/package.VcxProj \
...
# Docker drivers
bin_SCRIPTS = utilities/ovs-docker utilities/ovs-pki $(am__append_32) \
	ovn/utilities/ovn-docker-overlay-driver \
	ovn/utilities/ovn-docker-underlay-driver
...
dist_scripts_DATA = 
INSTALL_DATA_LOCAL = lib-install-data-local $(am__append_42)
UNINSTALL_LOCAL = $(am__append_43) ovs-uninstall-local
# ovsdb-tool.1
# ovsdb-client.1
# ovsdb-server.1
man_MANS = lib/ovs-fields.7 utilities/ovs-appctl.8 utilities/ovs-ctl.8 \
...
MAN_ROOTS = utilities/ovs-appctl.8.in \
	...
	utilities/ovs-pki.8.in utilities/ovs-tcpdump.8.in \
	utilities/ovs-tcpundump.1.in \
	utilities/ovs-vlan-bug-workaround.8.in utilities/ovs-test.8.in \
	utilities/ovs-vlan-test.8.in utilities/ovs-vsctl.8.in \
	$(am__append_38) vswitchd/ovs-vswitchd.8.in \
	ovsdb/ovsdb-tool.1.in ovsdb/ovsdb-client.1.in \
	ovsdb/ovsdb-server.1.in ovsdb/ovsdb-idlc.1 vtep/vtep-ctl.8.in \
...
noinst_HEADERS = $(EXTRA_DIST) include/sparse/arpa/inet.h \
	include/sparse/assert.h include/sparse/bmi2intrin.h \
	include/sparse/emmintrin.h include/sparse/math.h \
	include/sparse/netinet/in.h include/sparse/netinet/ip6.h \
	include/sparse/netpacket/packet.h include/sparse/pthread.h \
	include/sparse/rte_atomic.h include/sparse/rte_lcore.h \
	include/sparse/rte_vect.h include/sparse/sys/socket.h \
	include/sparse/sys/wait.h include/windows/arpa/inet.h \
	include/windows/dirent.h include/windows/getopt.h \
	include/windows/linux/netfilter/nf_conntrack_common.h \
	include/windows/linux/netfilter/nf_conntrack_ftp.h \
	include/windows/linux/netfilter/nf_conntrack_sctp.h \
	include/windows/linux/netfilter/nf_conntrack_tcp.h \
...
lib_LTLIBRARIES = lib/libopenvswitch.la lib/libsflow.la \
	ofproto/libofproto.la ovsdb/libovsdb.la vtep/libvtep.la \
	ovn/lib/libovn.la
...
pkgdata_DATA = vswitchd/vswitch.ovsschema vtep/vtep.ovsschema \
	ovn/ovn-sb.ovsschema ovn/ovn-nb.ovsschema
sbin_SCRIPTS = $(am__append_35)

# ovs-vtep
scripts_SCRIPTS = utilities/ovs-check-dead-ifs utilities/ovs-ctl \
	utilities/ovs-save $(am__append_40) vtep/ovs-vtep \
	ovn/utilities/ovn-ctl ovn/utilities/ovndb-servers.ocf
completion_SCRIPTS = utilities/ovs-appctl-bashcomp.bash \
	utilities/ovs-vsctl-bashcomp.bash
scripts_DATA = utilities/ovs-lib
SUFFIXES = .in .xml $(am__append_50) .ovsidl .ovsschema
check_DATA = $(am__append_47)
...
pkgconfig_DATA = $(srcdir)/lib/libopenvswitch.pc \
	$(srcdir)/lib/libsflow.pc $(srcdir)/ofproto/libofproto.pc \
	$(srcdir)/ovsdb/libovsdb.pc

# This file is purely used for checking the style of the python build tools.
FLAKE8_PYFILES = ofproto/ipfix-gen-entities utilities/ovs-pcap.in \
	utilities/checkpatch.py utilities/ovs-dev.py \
	utilities/ovs-tcpdump.in $(am__append_41) $(CHECK_PYFILES) \
	xenserver/usr_share_openvswitch_scripts_ovs-xapi-sync \
	$(filter-out python/ovs/dirs.py,$(PYFILES)) python/setup.py \
	python/build/__init__.py python/build/nroff.py \
...
lib_libopenvswitch_la_SOURCES = lib/aes128.c lib/aes128.h \
	...
	lib/lldp/lldp.c lib/lldp/lldp-const.h lib/lldp/lldp-tlv.h \
	lib/lldp/lldpd.c lib/lldp/lldpd.h lib/lldp/lldpd-structs.c \
	lib/lldp/lldpd-structs.h $(am__append_16) $(am__append_17) \
	$(am__append_20) $(am__append_21) $(am__append_22) \
	$(am__append_23) $(am__append_24) $(am__append_25) \
	$(am__append_26) $(am__append_27) $(am__append_28) \
	$(am__append_30)
nodist_lib_libopenvswitch_la_SOURCES = lib/dirs.c lib/vswitch-idl.c \
	lib/vswitch-idl.h $(am__append_29)
...
lib_libsflow_la_CFLAGS = $(AM_CFLAGS) $(am__append_18) \
	$(am__append_19)
...
ofproto_libofproto_la_LIBADD = lib/libsflow.la $(am__append_31)
...
bugtool_plugins = utilities/bugtool/plugins/kernel-info/openvswitch.xml \
	utilities/bugtool/plugins/network-status/openvswitch.xml \
	utilities/bugtool/plugins/system-configuration.xml \
	utilities/bugtool/plugins/system-logs/openvswitch.xml \
	utilities/bugtool/plugins/system-configuration/openvswitch.xml \
...
.SUFFIXES:
.SUFFIXES: .in .xml .h .hstamp .ovsidl .ovsschema .c .lo .o .obj
am--refresh: Makefile
	@:
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(srcdir)/manpages.mk $(srcdir)/Documentation/automake.mk $(srcdir)/m4/automake.mk $(srcdir)/lib/automake.mk $(srcdir)/ofproto/automake.mk $(srcdir)/utilities/automake.mk $(srcdir)/utilities/bugtool/automake.mk $(srcdir)/tests/automake.mk $(srcdir)/include/automake.mk $(srcdir)/include/ovn/automake.mk $(srcdir)/include/openflow/automake.mk $(srcdir)/include/openvswitch/automake.mk $(srcdir)/include/sparse/automake.mk $(srcdir)/include/windows/automake.mk $(srcdir)/third-party/automake.mk $(srcdir)/debian/automake.mk $(srcdir)/vswitchd/automake.mk $(srcdir)/ovsdb/automake.mk $(srcdir)/rhel/automake.mk $(srcdir)/xenserver/automake.mk $(srcdir)/python/automake.mk $(srcdir)/tutorial/automake.mk $(srcdir)/vtep/automake.mk $(srcdir)/datapath-windows/automake.mk $(srcdir)/datapath-windows/include/automake.mk $(srcdir)/windows/automake.mk $(srcdir)/ovn/automake.mk $(srcdir)/ovn/controller/automake.mk $(srcdir)/ovn/controller-vtep/automake.mk $(srcdir)/ovn/lib/automake.mk $(srcdir)/ovn/northd/automake.mk $(srcdir)/ovn/utilities/automake.mk $(srcdir)/ovn/utilities/bugtool/automake.mk $(srcdir)/selinux/automake.mk $(srcdir)/build-aux/automake.mk $(am__configure_deps)
	@for dep in $?; do \
...
$(srcdir)/manpages.mk $(srcdir)/Documentation/automake.mk $(srcdir)/m4/automake.mk $(srcdir)/lib/automake.mk $(srcdir)/ofproto/automake.mk $(srcdir)/utilities/automake.mk $(srcdir)/utilities/bugtool/automake.mk $(srcdir)/tests/automake.mk $(srcdir)/include/automake.mk $(srcdir)/include/ovn/automake.mk $(srcdir)/include/openflow/automake.mk $(srcdir)/include/openvswitch/automake.mk $(srcdir)/include/sparse/automake.mk $(srcdir)/include/windows/automake.mk $(srcdir)/third-party/automake.mk $(srcdir)/debian/automake.mk $(srcdir)/vswitchd/automake.mk $(srcdir)/ovsdb/automake.mk $(srcdir)/rhel/automake.mk $(srcdir)/xenserver/automake.mk $(srcdir)/python/automake.mk $(srcdir)/tutorial/automake.mk $(srcdir)/vtep/automake.mk $(srcdir)/datapath-windows/automake.mk $(srcdir)/datapath-windows/include/automake.mk $(srcdir)/windows/automake.mk $(srcdir)/ovn/automake.mk $(srcdir)/ovn/controller/automake.mk $(srcdir)/ovn/controller-vtep/automake.mk $(srcdir)/ovn/lib/automake.mk $(srcdir)/ovn/northd/automake.mk $(srcdir)/ovn/utilities/automake.mk $(srcdir)/ovn/utilities/bugtool/automake.mk $(srcdir)/selinux/automake.mk $(srcdir)/build-aux/automake.mk $(am__empty):
...
lib/libopenvswitch.sym: $(top_builddir)/config.status $(top_srcdir)/lib/libopenvswitch.sym.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
ovn/lib/libovn.sym: $(top_builddir)/config.status $(top_srcdir)/ovn/lib/libovn.sym.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
ovn/lib/$(am__dirstamp):
	@$(MKDIR_P) ovn/lib
	@: > ovn/lib/$(am__dirstamp)
ovn/lib/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) ovn/lib/$(DEPDIR)
	@: > ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/actions.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/expr.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/lex.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/ovn-util.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/logical-fields.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/ovn-nb-idl.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)
ovn/lib/ovn-sb-idl.lo: ovn/lib/$(am__dirstamp) \
	ovn/lib/$(DEPDIR)/$(am__dirstamp)

ovn/lib/libovn.la: $(ovn_lib_libovn_la_OBJECTS) $(ovn_lib_libovn_la_DEPENDENCIES) $(EXTRA_ovn_lib_libovn_la_DEPENDENCIES) ovn/lib/$(am__dirstamp)
	$(AM_V_CCLD)$(ovn_lib_libovn_la_LINK) -rpath $(libdir) $(ovn_lib_libovn_la_OBJECTS) $(ovn_lib_libovn_la_LIBADD) $(LIBS)
ovsdb/$(am__dirstamp):
	@$(MKDIR_P) ovsdb
	@: > ovsdb/$(am__dirstamp)
...
clean-sbinPROGRAMS:
	...
	echo " rm -f" $$list; \
	rm -f $$list
ovn/controller-vtep/$(am__dirstamp):
	@$(MKDIR_P) ovn/controller-vtep
	@: > ovn/controller-vtep/$(am__dirstamp)
ovn/controller-vtep/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) ovn/controller-vtep/$(DEPDIR)
	@: > ovn/controller-vtep/$(DEPDIR)/$(am__dirstamp)
ovn/controller-vtep/binding.$(OBJEXT):  \
	ovn/controller-vtep/$(am__dirstamp) \
	ovn/controller-vtep/$(DEPDIR)/$(am__dirstamp)
...
ovn/controller-vtep/ovn-controller-vtep$(EXEEXT): $(ovn_controller_vtep_ovn_controller_vtep_OBJECTS) $(ovn_controller_vtep_ovn_controller_vtep_DEPENDENCIES) $(EXTRA_ovn_controller_vtep_ovn_controller_vtep_DEPENDENCIES) ovn/controller-vtep/$(am__dirstamp)
	@rm -f ovn/controller-vtep/ovn-controller-vtep$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(ovn_controller_vtep_ovn_controller_vtep_OBJECTS) $(ovn_controller_vtep_ovn_controller_vtep_LDADD) $(LIBS)
ovn/controller/$(am__dirstamp):
	@$(MKDIR_P) ovn/controller
	@: > ovn/controller/$(am__dirstamp)
ovn/controller/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) ovn/controller/$(DEPDIR)
	@: > ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/binding.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/chassis.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/encaps.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/lflow.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/lport.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/ofctrl.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/pinctrl.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/patch.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/ovn-controller.$(OBJEXT):  \
	ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)
ovn/controller/physical.$(OBJEXT): ovn/controller/$(am__dirstamp) \
	ovn/controller/$(DEPDIR)/$(am__dirstamp)

ovn/controller/ovn-controller$(EXEEXT): $(ovn_controller_ovn_controller_OBJECTS) $(ovn_controller_ovn_controller_DEPENDENCIES) $(EXTRA_ovn_controller_ovn_controller_DEPENDENCIES) ovn/controller/$(am__dirstamp)
	@rm -f ovn/controller/ovn-controller$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(ovn_controller_ovn_controller_OBJECTS) $(ovn_controller_ovn_controller_LDADD) $(LIBS)
ovn/northd/$(am__dirstamp):
	@$(MKDIR_P) ovn/northd
	@: > ovn/northd/$(am__dirstamp)
ovn/northd/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) ovn/northd/$(DEPDIR)
	@: > ovn/northd/$(DEPDIR)/$(am__dirstamp)
ovn/northd/ovn-northd.$(OBJEXT): ovn/northd/$(am__dirstamp) \
	ovn/northd/$(DEPDIR)/$(am__dirstamp)

ovn/northd/ovn-northd$(EXEEXT): $(ovn_northd_ovn_northd_OBJECTS) $(ovn_northd_ovn_northd_DEPENDENCIES) $(EXTRA_ovn_northd_ovn_northd_DEPENDENCIES) ovn/northd/$(am__dirstamp)
	@rm -f ovn/northd/ovn-northd$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(ovn_northd_ovn_northd_OBJECTS) $(ovn_northd_ovn_northd_LDADD) $(LIBS)
ovn/utilities/$(am__dirstamp):
	@$(MKDIR_P) ovn/utilities
	@: > ovn/utilities/$(am__dirstamp)
ovn/utilities/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) ovn/utilities/$(DEPDIR)
	@: > ovn/utilities/$(DEPDIR)/$(am__dirstamp)
ovn/utilities/ovn-nbctl.$(OBJEXT): ovn/utilities/$(am__dirstamp) \
	ovn/utilities/$(DEPDIR)/$(am__dirstamp)

ovn/utilities/ovn-nbctl$(EXEEXT): $(ovn_utilities_ovn_nbctl_OBJECTS) $(ovn_utilities_ovn_nbctl_DEPENDENCIES) $(EXTRA_ovn_utilities_ovn_nbctl_DEPENDENCIES) ovn/utilities/$(am__dirstamp)
	@rm -f ovn/utilities/ovn-nbctl$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(ovn_utilities_ovn_nbctl_OBJECTS) $(ovn_utilities_ovn_nbctl_LDADD) $(LIBS)
ovn/utilities/ovn-sbctl.$(OBJEXT): ovn/utilities/$(am__dirstamp) \
	ovn/utilities/$(DEPDIR)/$(am__dirstamp)

ovn/utilities/ovn-sbctl$(EXEEXT): $(ovn_utilities_ovn_sbctl_OBJECTS) $(ovn_utilities_ovn_sbctl_DEPENDENCIES) $(EXTRA_ovn_utilities_ovn_sbctl_DEPENDENCIES) ovn/utilities/$(am__dirstamp)
	@rm -f ovn/utilities/ovn-sbctl$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(ovn_utilities_ovn_sbctl_OBJECTS) $(ovn_utilities_ovn_sbctl_LDADD) $(LIBS)
ovn/utilities/ovn-trace.$(OBJEXT): ovn/utilities/$(am__dirstamp) \
	ovn/utilities/$(DEPDIR)/$(am__dirstamp)

ovn/utilities/ovn-trace$(EXEEXT): $(ovn_utilities_ovn_trace_OBJECTS) $(ovn_utilities_ovn_trace_DEPENDENCIES) $(EXTRA_ovn_utilities_ovn_trace_DEPENDENCIES) ovn/utilities/$(am__dirstamp)
	@rm -f ovn/utilities/ovn-trace$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(ovn_utilities_ovn_trace_OBJECTS) $(ovn_utilities_ovn_trace_LDADD) $(LIBS)
...
tests/test-ofpbuf.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
tests/test-ovn.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
...
mostlyclean-compile:
	...
	-rm -f ofproto/*.$(OBJEXT)
	-rm -f ofproto/*.lo
	-rm -f ovn/controller-vtep/*.$(OBJEXT)
	-rm -f ovn/controller/*.$(OBJEXT)
	-rm -f ovn/lib/*.$(OBJEXT)
	-rm -f ovn/lib/*.lo
	-rm -f ovn/northd/*.$(OBJEXT)
	-rm -f ovn/utilities/*.$(OBJEXT)
	-rm -f ovsdb/*.$(OBJEXT)
	-rm -f ovsdb/*.lo
	-rm -f tests/*.$(OBJEXT)
...
include ovn/controller-vtep/$(DEPDIR)/binding.Po
include ovn/controller-vtep/$(DEPDIR)/gateway.Po
include ovn/controller-vtep/$(DEPDIR)/ovn-controller-vtep.Po
include ovn/controller-vtep/$(DEPDIR)/vtep.Po
include ovn/controller/$(DEPDIR)/binding.Po
include ovn/controller/$(DEPDIR)/chassis.Po
include ovn/controller/$(DEPDIR)/encaps.Po
include ovn/controller/$(DEPDIR)/lflow.Po
include ovn/controller/$(DEPDIR)/lport.Po
include ovn/controller/$(DEPDIR)/ofctrl.Po
include ovn/controller/$(DEPDIR)/ovn-controller.Po
include ovn/controller/$(DEPDIR)/patch.Po
include ovn/controller/$(DEPDIR)/physical.Po
include ovn/controller/$(DEPDIR)/pinctrl.Po
include ovn/lib/$(DEPDIR)/actions.Plo
include ovn/lib/$(DEPDIR)/expr.Plo
include ovn/lib/$(DEPDIR)/lex.Plo
include ovn/lib/$(DEPDIR)/logical-fields.Plo
include ovn/lib/$(DEPDIR)/ovn-nb-idl.Plo
include ovn/lib/$(DEPDIR)/ovn-sb-idl.Plo
include ovn/lib/$(DEPDIR)/ovn-util.Plo
include ovn/northd/$(DEPDIR)/ovn-northd.Po
include ovn/utilities/$(DEPDIR)/ovn-nbctl.Po
include ovn/utilities/$(DEPDIR)/ovn-sbctl.Po
include ovn/utilities/$(DEPDIR)/ovn-trace.Po
...
include tests/$(DEPDIR)/test-ovn.Po
...
include tests/dpdk/$(DEPDIR)/ring_client.Po
...
clean-libtool:
	...
	-rm -rf ovn/controller/.libs ovn/controller/_libs
	-rm -rf ovn/controller-vtep/.libs ovn/controller-vtep/_libs
	-rm -rf ovn/lib/.libs ovn/lib/_libs
	-rm -rf ovn/northd/.libs ovn/northd/_libs
	-rm -rf ovn/utilities/.libs ovn/utilities/_libs
...
install-ovnincludeHEADERS: $(ovninclude_HEADERS)
	@$(NORMAL_INSTALL)
	@list='$(ovninclude_HEADERS)'; test -n "$(ovnincludedir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(ovnincludedir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(ovnincludedir)" || exit 1; \
	fi; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  echo "$$d$$p"; \
	...
	while read files; do \
	  echo " $(INSTALL_HEADER) $$files '$(DESTDIR)$(ovnincludedir)'"; \
	  $(INSTALL_HEADER) $$files "$(DESTDIR)$(ovnincludedir)" || exit $$?; \
	done

uninstall-ovnincludeHEADERS:
	@$(NORMAL_UNINSTALL)
	@list='$(ovninclude_HEADERS)'; test -n "$(ovnincludedir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(ovnincludedir)'; $(am__uninstall_files_from_dir)
...
distcleancheck: distclean
	...
	@test `$(distcleancheck_listfiles) | wc -l` -eq 0 \
	  || { echo "ERROR: files left in build directory after distclean:" ; \
	       ...
	       exit 1; } >&2
check-am: all-am
	$(MAKE) $(AM_MAKEFLAGS) $(check_SCRIPTS) $(dist_check_SCRIPTS) \
	  $(check_DATA)
...
installdirs-am:
	for dir in "$(DESTDIR)$(libdir)" "$(DESTDIR)$(bindir)" "$(DESTDIR)$(sbindir)" "$(DESTDIR)$(bindir)" "$(DESTDIR)$(completiondir)" "$(DESTDIR)$(pkgdatadir)" "$(DESTDIR)$(sbindir)" "$(DESTDIR)$(scriptsdir)" "$(DESTDIR)$(sbindir)" "$(DESTDIR)$(scriptsdir)" "$(DESTDIR)$(man1dir)" "$(DESTDIR)$(man5dir)" "$(DESTDIR)$(man7dir)" "$(DESTDIR)$(man8dir)" "$(DESTDIR)$(pkgdatadir)" "$(DESTDIR)$(scriptsdir)" "$(DESTDIR)$(pkgdatadir)" "$(DESTDIR)$(pkgconfigdir)" "$(DESTDIR)$(pkgdatadir)" "$(DESTDIR)$(scriptsdir)" "$(DESTDIR)$(openflowincludedir)" "$(DESTDIR)$(openvswitchincludedir)" "$(DESTDIR)$(ovnincludedir)"; do \
...
distclean-generic:
	...
	-rm -f ovn/controller-vtep/$(DEPDIR)/$(am__dirstamp)
	-rm -f ovn/controller-vtep/$(am__dirstamp)
	-rm -f ovn/controller/$(DEPDIR)/$(am__dirstamp)
	-rm -f ovn/controller/$(am__dirstamp)
	-rm -f ovn/lib/$(DEPDIR)/$(am__dirstamp)
	-rm -f ovn/lib/$(am__dirstamp)
	-rm -f ovn/northd/$(DEPDIR)/$(am__dirstamp)
	-rm -f ovn/northd/$(am__dirstamp)
	-rm -f ovn/utilities/$(DEPDIR)/$(am__dirstamp)
	-rm -f ovn/utilities/$(am__dirstamp)
	-rm -f ovsdb/$(DEPDIR)/$(am__dirstamp)
	-rm -f ovsdb/$(am__dirstamp)
	-rm -f tests/$(DEPDIR)/$(am__dirstamp)
	-rm -f tests/$(am__dirstamp)
	-rm -f tests/dpdk/$(DEPDIR)/$(am__dirstamp)
	-rm -f tests/dpdk/$(am__dirstamp)
...
distclean: distclean-recursive
	...
	-rm -rf lib/$(DEPDIR) lib/lldp/$(DEPDIR) ofproto/$(DEPDIR) ovn/controller-vtep/$(DEPDIR) ovn/controller/$(DEPDIR) ovn/lib/$(DEPDIR) ovn/northd/$(DEPDIR) ovn/utilities/$(DEPDIR) ovsdb/$(DEPDIR) tests/$(DEPDIR) tests/dpdk/$(DEPDIR) utilities/$(DEPDIR) vswitchd/$(DEPDIR) vtep/$(DEPDIR)
	-rm -f Makefile
...
install-data-am: install-completionSCRIPTS install-data-local \
	...
	install-openvswitchincludeHEADERS install-ovnincludeHEADERS \
...
uninstall-am: uninstall-binPROGRAMS uninstall-binSCRIPTS \
	...
	uninstall-openvswitchincludeHEADERS \
	uninstall-ovnincludeHEADERS uninstall-pkgconfigDATA \
